...
export const IconCards = () => (
  <svg {...base}>
    <rect x="3" y="6" width="12" height="15" rx="2.5" />
    <path d="M8 3h8a3 3 0 0 1 3 3v11" />
  </svg>
);
...
export const IconHeartFilled = () => (
  <svg {...base} fill="currentColor" strokeWidth={1.4}>
    <path d="M12 20s-7-4.35-7-9.5A4.5 4.5 0 0 1 12 7a4.5 4.5 0 0 1 7 3.5C19 15.65 12 20 12 20Z" />
  </svg>
);
...
export const IconSparkle = () => (
  <svg {...base}>
    <path d="M12 3l1.9 4.9L19 9.8l-4.3 2.6L13.4 18 12 14.2 10.6 18l-1.3-5.6L5 9.8l5.1-1.9L12 3Z" />
  </svg>
);
